...
Try to hook or reverse engineer the app using the methods from section [Anti-Debugging Detection](https://mas.owasp.org/MASTG/Android/0x05j-Testing-Resiliency-Against-Reverse-Engineering#anti-debugging).
